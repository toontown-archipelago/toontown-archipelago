...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'skh': ["I have the Stock Market.",
         "Parden me, I have to stock-in with this one."],
 'clp': ["The Country Club is off-limits for toons.",
         "I'm the Club President of this floor."],
 ...
 'hat': ["All of my clients have protection.",
