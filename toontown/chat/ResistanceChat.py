...
RESISTANCE_MONEY = 2
RESISTANCE_TOGGLE_EVENT = 'set-unites-allowed'
...
resistanceDict = {RESISTANCE_TOONUP: {'menuName': TTL.ResistanceToonupMenu,
 ...
 RESISTANCE_RESTOCK: {'menuName': TTL.ResistanceRestockMenu,
                      ...
                      'values': [0,
                                 ...
                                 5,
                                 6],
                      'extra': [TTL.ResistanceChatOne,
                                TTL.ResistanceChatTwo,
                                TTL.ResistanceChatThree,
                                TTL.ResistanceChatFour,
                                TTL.ResistanceChatFive,
                                TTL.ResistanceChatSix,
                                TTL.ResistanceChatSeven,],
                      'items': [0,
                                1,
                                2,
                                3,
