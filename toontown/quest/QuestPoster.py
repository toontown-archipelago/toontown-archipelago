...
class QuestPoster(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        self.rewardText = DirectLabel(parent=self.questFrame, relief=None, text='', text_fg=self.colors['rewardRed'], text_scale=0.03, text_align=TextNode.ACenter, text_wordwrap=25.0, textMayChange=1, pos=(0, 0, -0.23), text_shadow=(0, 0, 0, .5))
