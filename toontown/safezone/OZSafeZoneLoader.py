...
class OZSafeZoneLoader(SafeZoneLoader):
    ...
    def load(self):
        ...
        self.geyserSound = loader.loadSfx('phase_6/audio/sfx/OZ_Geyser_No_Toon.ogg')
    ...
    def setGeyserAnim(self, task = None):
        ...
        for av in avList:
            ...
            if distance < 7.0:
                ...
                animTrack.append(ActorInterval(av, 'jump-idle', loop=1, endTime=5.5 * time))
                ...
                if local == 1:
                    ...
                    cameraTrack.append(Wait(5.0 * time))
