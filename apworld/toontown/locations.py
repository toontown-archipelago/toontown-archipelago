...
class ToontownLocationName(Enum):
    ...
    TOONUP_FEATHER_UNLOCKED =                   "Feather Maxed (Toon-up Training)"
    TOONUP_MEGAPHONE_UNLOCKED =                 "Megaphone Maxed (Toon-up Training)"
    TOONUP_LIPSTICK_UNLOCKED =                  "Lipstick Maxed (Toon-up Training)"
    TOONUP_CANE_UNLOCKED =                      "Bamboo Cane Maxed (Toon-up Training)"
    TOONUP_PIXIE_UNLOCKED =                     "Pixie Dust Maxed (Toon-up Training)"
    TOONUP_JUGGLING_UNLOCKED =                  "Juggling Cubes Maxed (Toon-up Training)"
    TOONUP_HIGHDIVE_UNLOCKED =                  "High Dive Maxed (MAXED Toon-up)"
    TRAP_BANANA_UNLOCKED =                      "Banana Peel Maxed (Trap Training)"
    TRAP_RAKE_UNLOCKED =                        "Rake Maxed (Trap Training)"
    TRAP_MARBLES_UNLOCKED =                     "Marbles Maxed (Trap Training)"
    TRAP_QUICKSAND_UNLOCKED =                   "Quicksand Maxed (Trap Training)"
    TRAP_TRAPDOOR_UNLOCKED =                    "Trapdoor Maxed (Trap Training)"
    TRAP_TNT_UNLOCKED =                         "TNT Maxed (Trap Training)"
    TRAP_TRAIN_UNLOCKED =                       "Railroad Maxed (MAXED Trap)"
    LURE_ONEBILL_UNLOCKED =                     "$1 Bill Maxed (Lure Training)"
    LURE_SMALLMAGNET_UNLOCKED =                 "Small Magnet Maxed (Lure Training)"
    LURE_FIVEBILL_UNLOCKED =                    "$5 Bill Maxed (Lure Training)"
    LURE_BIGMAGNET_UNLOCKED =                   "Big Magnet Maxed (Lure Training)"
    LURE_TENBILL_UNLOCKED =                     "$10 Bill Maxed (Lure Training)"
    LURE_HYPNO_UNLOCKED =                       "Hypno-Goggles Maxed (Lure Training)"
    LURE_PRESENTATION_UNLOCKED =                "Presentation Maxed (MAXED Lure)"
    SOUND_BIKEHORN_UNLOCKED =                   "Bike Horn Maxed (Sound Training)"
    SOUND_WHISTLE_UNLOCKED =                    "Whistle Maxed (Sound Training)"
    SOUND_BUGLE_UNLOCKED =                      "Bugle Maxed (Sound Training)"
    SOUND_AOOGAH_UNLOCKED =                     "Aoogah Maxed (Sound Training)"
    SOUND_TRUNK_UNLOCKED =                      "Elephant Trunk Maxed (Sound Training)"
    SOUND_FOG_UNLOCKED =                        "Foghorn Maxed (Sound Training)"
    SOUND_OPERA_UNLOCKED =                      "Opera Singer Maxed (MAXED Sound)"
    THROW_CUPCAKE_UNLOCKED =                    "Cupcake Maxed (Throw Training)"
    THROW_FRUITPIESLICE_UNLOCKED =              "Fruit Pie Slice Maxed (Throw Training)"
    THROW_CREAMPIESLICE_UNLOCKED =              "Cream Pie Slice Maxed (Throw Training)"
    THROW_WHOLEFRUIT_UNLOCKED =                 "Whole Fruit Pie Maxed (Throw Training)"
    THROW_WHOLECREAM_UNLOCKED =                 "Whole Cream Pie Maxed (Throw Training)"
    THROW_CAKE_UNLOCKED =                       "Birthday Cake Maxed (Throw Training)"
    THROW_WEDDING_UNLOCKED =                    "Wedding Cake Maxed (MAXED Throw)"
    SQUIRT_SQUIRTFLOWER_UNLOCKED =              "Squirting Flower Maxed (Squirt Training)"
    SQUIRT_GLASS_UNLOCKED =                     "Glass of Water Maxed (Squirt Training)"
    SQUIRT_SQUIRTGUN_UNLOCKED =                 "Squirt Gun Maxed (Squirt Training)"
    SQUIRT_SELTZER_UNLOCKED =                   "Seltzer Bottle Maxed (Squirt Training)"
    SQUIRT_HOSE_UNLOCKED =                      "Firehose Maxed (Squirt Training)"
    SQUIRT_CLOUD_UNLOCKED =                     "Stormcloud Maxed (Squirt Training)"
    SQUIRT_GEYSER_UNLOCKED =                    "Geyser Maxed (MAXED Squirt)"
    DROP_FLOWERPOT_UNLOCKED =                   "Flowerpot Maxed (Drop Training)"
    DROP_SANDBAG_UNLOCKED =                     "Sandbag Maxed (Drop Training)"
    DROP_ANVIL_UNLOCKED =                       "Anvil Maxed (Drop Training)"
    DROP_BIGWEIGHT_UNLOCKED =                   "Big Weight Maxed (Drop Training)"
    DROP_SAFE_UNLOCKED =                        "Safe Maxed (Drop Training)"
    DROP_PIANO_UNLOCKED =                       "Piano Maxed (Drop Training)"
    DROP_BOAT_UNLOCKED =                        "Toontanic Maxed (MAXED Drop)"
